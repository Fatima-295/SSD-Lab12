...
class AdditionalSecurityExpectationsTests {
    ...
    // Use an explicitly invalid token to assert Unauthorized
    String invalid = "invalid.token.payload";
    mvc.perform(get("/api/accounts/mine").header("Authorization","Bearer "+invalid))
